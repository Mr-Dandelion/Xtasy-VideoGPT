...
NUM_FRAMES = int(os.environ.get("NUM_FRAMES", 4))  # Number of video frames (if using video)
NUM_CONTEXT_IMAGES = int(os.environ.get("NUM_CONTEXT_IMAGES", 4))  # Number of context images for video
